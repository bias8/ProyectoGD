...
<img width="1420" height="726" alt="Diagrama" src="https://github.com/user-attachments/assets/04682dc5-7a57-4673-b6d6-a5a547455a8b" />
...
$$\dot{x} = b_1 x - b_2 x^2 - b_3 x^3$$

$$\dot{y} = c_1 z y - c_2 y - c_3 x^2 y^2 + \rho_i$$

$$\dot{z} = a_1 z^2 x y - a_2 z - a_3 z^2 x$$

donde todos los parámetros son estrictamente positivos y se asume una dinámica controlada por un parámetro de inmunoterapia o intervención de control dado por $i \geq 0$. La Ecuación (1) describe la población de células sanas ($x$) con una dinámica de crecimiento controlada por sus propios parámetros poblacionales, la Ecuación (2) modela la respuesta del sistema biológico o de células efectoras ($y$) y la Ecuación (3) representa la evolución de la población patológica ($z$). El análisis de este sistema permite evaluar la positividad de las poblaciones y buscar la eliminación de la condición patológica.
